...
public class Hora {
    ...
    public Hora(String s) {
        ...
        if (j.length == 3) {
            ...
            if (Integer.parseInt(j[2]) >= 0)
                ...
                System.exit(0);
        } else if (j.length == 1 && Integer.parseInt(j[0])>=0) {
    ...
    public String toString() {
        ...
        return formatter.format(converttoHMS().h) + ":" + formatter.format(converttoHMS().m) + ":"
                + formatter.format(converttoHMS().s);
    }
